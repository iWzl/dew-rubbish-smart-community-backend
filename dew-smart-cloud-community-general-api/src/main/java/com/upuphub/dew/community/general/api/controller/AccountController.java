...
public class AccountController {
    ...
    @ApiParam(name = "passwordReq",required = true,value = "用户密码修改的验证信息组")
    @PutMapping(value = "/password/reset")
    public ServiceResponseMessage resetPassword(@RequestBody @Validated PasswordReq passwordReq){
        return accountService.resetUserPassword(passwordReq.getEmail(),passwordReq.getCode(),passwordReq.getPassword());
    }
