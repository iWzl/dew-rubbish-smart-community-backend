...
@ComponentScan("com.upuphub.dew.community.operation.api.controller")
@Configuration
@EnableSwagger2
public class Swagger2Configuration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //扫描Api包
                .apis(RequestHandlerSelectors.basePackage("com.upuphub.dew.community.operation.api.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("DEW RBC API")
                .description("DEW RUBBISH COMMUNITY OSS API接口")//api描述
