...
@ComponentScan("com.upuphub.dew.community.machine.api.controller")
@Configuration
@EnableSwagger2
public class Swagger2Configuration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //扫描Api包
                .apis(RequestHandlerSelectors.basePackage("com.upuphub.dew.community.machine.api.controller"))
    ...
    private List<ApiKey> securitySchemes() {
        return newArrayList(
                new ApiKey("X-DEW-IoTDA-MAC", "X-DEW-IoTDA-MAC", "header"));
    }
    ...
    private List<SecurityReference> defaultAuth() {
        ...
        return newArrayList(
                new SecurityReference("X-DEW-IoTDA-MAC", authorizationScopes));
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("DEW IoTDA API")
                .description("DEW RUBBISH COMMUNITY IoTDA API接口")//api描述
